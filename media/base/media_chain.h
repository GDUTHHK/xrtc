...
namespace xrtc {
 ...
 enum class MediaObjectId {
    kMidUnknownId,
    kMidX264EncoderFilterId,
 };

class MediaObject {
public:
    MediaObject(MediaObjectId mid = MediaObjectId::kMidUnknownId) : mid_(mid) {}
    virtual ~MediaObject() {}
    ...
    MediaObjectId mid() const { return mid_; }
private:
    mid_;
};
...
public:
    ...
    MediaObject* FindObjectById(MediaObjectId mid) const ;
